...
export async function main(ns) {
	...
	ns.tprint(`'${ns.getServerMaxRam(host)}' '${ns.getServerUsedRam(host)}' '${ns.getScriptRam(script)}' Launching script '${script}' on server '${host}' with ${threads} threads and the following arguments: ${script_args}`);
